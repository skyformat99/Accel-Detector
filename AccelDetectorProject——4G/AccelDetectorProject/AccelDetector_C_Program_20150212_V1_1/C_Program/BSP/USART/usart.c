...
**	Parameters	:
**	Retval		:
**	Description	: 此函数通常用于debug，打印调试信息
**	Attention	:
---------------------------------------------------------------------------*/ 
...
void USART1_Config(void)
{
	...
	RCC_APB2PeriphClockCmd(DBG_TX_RCC_Periph|DBG_RX_RCC_Periph, ENABLE);
...
{ 	
	...
	{	 			   
		...
		TIM4_Set(0);			//关闭TIM4  
		UART1SendString(USART2_RX_BUF,USART2_RX_STA&0x7fff);	//输出LOG信息
