...
{										   
	...
	//读取数据(读寄存器时,并不需要读2次)
	LCD_RD_CLR;
	delay_us(5);//FOR 8989,延时5us     //modified by  YZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ					   
	LCD_RD_SET;
	t=DATAIN;  
	LCD_CS_SET; 
#else
...
u16 LCD_ReadPoint(u16 x,u16 y)
{
	...
	LCD_RD_CLR;					   
	LCD_RD_SET;
	delay_us(2);//FOR 9320,延时2us	//modified by YZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ				   
	//dummy READ
	LCD_RD_CLR;					   
	delay_us(2);//FOR 8989,延时2us	//modified by YZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ				   
	LCD_RD_SET;
	t=DATAIN;  
	LCD_CS_SET;
#else
...
{  
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7|GPIO_Pin_6|GPIO_Pin_5|GPIO_Pin_4|GPIO_Pin_3;	   //GPIO_Pin_10
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;  //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOD, &GPIO_InitStructure); //GPIOC	
	GPIO_SetBits(GPIOD,GPIO_Pin_7|GPIO_Pin_6|GPIO_Pin_5|GPIO_Pin_4|GPIO_Pin_3);
...
/*printf(" LCD ID:%x\n",DeviceCode); //打印LCD ID 	 */
	...
	/*DeviceCode==0x9325 TonyYang Tested Date:2012_09_10*/ 
