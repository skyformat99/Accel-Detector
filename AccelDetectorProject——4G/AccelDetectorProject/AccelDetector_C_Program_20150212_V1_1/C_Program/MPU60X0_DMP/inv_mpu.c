...
//    char test_packet[4] = {0};
    ...
    if (result == 0x03) {                                                                                      //有次磁力计是0x07,没有是0x03
...
#if (MPU6000_IS_SPI_USED == 1)
	#define i2c_write   MPU6000_Dummy_i2c_write
	#define i2c_read    MPU6000_Dummy_i2c_read
	#define delay_ms    delay_ms
	#define get_ms      get_ms
#elif (MPU6000_IS_I2C_USED == 1) 
